...
const ProductPopular = () => {
  return (
    <div
      className="flex flex-col bg-white shadow-md border-1 border-gray-200 h-80 px-4 rounded-xl justify-start "
    >
      <img src="/img/image copy 2.png" className="w-50 h-50 rounded-xl mt-3" />
